...
class ClassificationDataModule(pl.LightningDataModule):
    def __init__(self, dataset_dir: Path, batch_size : int, pretrained_model_name: str) -> None:
        super().__init__()
        self.train_file = dataset_dir.joinpath('train_en.txt')
        self.val_file = dataset_dir.joinpath('val_en.txt')
        self.test_file = dataset_dir.joinpath('test_en.txt')
...
if __name__ == '__main__':
    ...
    dataset_dir = pathlib.Path('dataset', 'en_books')
    batch_size = 1

    run_name = 'flat-20-batch1-steplr'
