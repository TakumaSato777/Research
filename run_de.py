...
class ClassificationDataModule(pl.LightningDataModule):
    def __init__(self, dataset_dir: Path, batch_size : int, pretrained_model_name: str) -> None:
        super().__init__()
        self.train_file = dataset_dir.joinpath('train_de.csv')
        self.val_file = dataset_dir.joinpath('val_de.csv')
        self.test_file = dataset_dir.joinpath('test_de.csv')
