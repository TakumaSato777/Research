...
class ClassificationDataModule(pl.LightningDataModule):
    def __init__(self, dataset_dir: Path, batch_size : int, pretrained_model_name: str) -> None:
        super().__init__()
        self.train_file = dataset_dir.joinpath('train_en_de_fr_ja.csv')
        self.val_file = dataset_dir.joinpath('val_en_de_fr_ja.csv')
        self.test_file = dataset_dir.joinpath('test_ja.csv')
...
if __name__ == '__main__':
    ...
    dataset_dir = pathlib.Path('dataset', 'multi_music')
    ###change###
    batch_size = 32

    run_name = 'endefrja_ja_zeroshot'
