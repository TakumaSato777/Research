...
class ClassificationDataModule(pl.LightningDataModule):
    def __init__(self, dataset_dir: Path, batch_size : int, pretrained_model_name: str) -> None:
        super().__init__()
        self.train_file = dataset_dir.joinpath('train_en.csv')
        self.val_file = dataset_dir.joinpath('val_en.csv')
        self.test_file = dataset_dir.joinpath('test_en.csv')
...
if __name__ == '__main__':
    ...
    run_name = 'en_not_zeroshot_xlm-roberta-base'
