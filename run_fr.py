...
class ClassificationDataModule(pl.LightningDataModule):
    def __init__(self, dataset_dir: Path, batch_size : int, pretrained_model_name: str) -> None:
        super().__init__()
        self.train_file = dataset_dir.joinpath('train_fr.csv')
        self.val_file = dataset_dir.joinpath('val_fr.csv')
        self.test_file = dataset_dir.joinpath('test_fr.csv')
